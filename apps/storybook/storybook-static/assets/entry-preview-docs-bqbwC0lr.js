import {
	...
	d as nt,
	b as yn,
} from "./chunk-XP5HYGXS-rhzvizV_.js";
import { R as ft, r as Ge } from "./index-BGsE_GxY.js";
import {
	n as Ai,
	y as Ci,
	c as Di,
...
var Si = K({
			...
			(o.prototype._version = 3),
				...
				(o.prototype._generateSourcesContent = function (u, h) {
					return u.map(function (p) {
						...
						return Object.hasOwn(this._sourcesContents, m)
	...
	Mi = K({
		"../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js"(
			...
			(u.fromSourceMap = (g, F) => h.fromSourceMap(g, F)),
				...
				(u.prototype._charIsMappingSeparator = (g, F) => {
					var A = g.charAt(F);
					return A === ";" || A === ",";
				}),
				(u.prototype._parseMappings = (g, F) => {
			...
			function h(g, F) {
				...
				w && (w = t.normalize(w)),
					...
					(this._absoluteSources = this._sources
						.toArray()
						.map((_) => t.computeSourceURL(w, _, F))),
					(this.sourceRoot = w),
				...
				(h.fromSourceMap = (g, F) => {
					...
					(A.sourceRoot = g._sourceRoot),
						...
						(A._absoluteSources = A._sources
							.toArray()
							.map((y) => t.computeSourceURL(A.sourceRoot, y, F)));
					for (
			...
			(h.prototype._parseMappings = function (g, F) {
				...
				(h.prototype._findMapping = (g, F, A, C, D, E) => {
					if (g[A] <= 0)
						throw new TypeError(
			...
			(m.prototype = Object.create(u.prototype)),
				...
				(m.prototype.originalPositionFor = function (g) {
					var F = {
						...
						A = r.search(F, this._sections, (D, E) => {
	...
	Wi = K({
		"../../node_modules/escodegen/escodegen.js"(e) {
			(() => {
				...
				function M(i) {
					return Object.hasOwn(oe.Expression, i.type);
				}
				function V(i) {
					return Object.hasOwn(oe.Statement, i.type);
				}
				(r = {
					Sequence: 0,
					Yield: 1,
...
`,
				...
				function Ir(i, l) {
					var a;
					for (a in l) Object.hasOwn(l, a) && (i[a] = l[a]);
					return i;
				}
				function Ft(i, l) {
					var a, c;
...
` && d++;
				...
				(oe.prototype.generatePattern = function (i, l, a) {
					...
					(oe.prototype.semicolon = (i) => (!b && i & Z ? "" : ";")),
					(oe.Statement = {
...
` && (d = ["{"])),
											...
											i.body[I].leadingComments && B
												? (O = this.generateStatement(i.body[I], J))
												: (O = fe(this.generateStatement(i.body[I], J))),
											d.push(O),
											he(Y(O).toString()) ||
...
`
					...
					(oe.Expression = {
						...
						Literal: (i, l, a) => {
							var c;
							if (Object.hasOwn(i, "raw") && x && _.raw)
								try {
									if (
					...
					(oe.prototype.generateExpression = function (i, l, a) {
						...
						return (
							(d = i.type || t.Property),
							_.verbatim && Object.hasOwn(i, _.verbatim)
								? fi(i, l)
	...
	gr = gi({
		"../../node_modules/acorn/dist/acorn.mjs"() {
			(bt = {
				...
				(Yr = zt.toString),
				(cr = Array.isArray || ((e) => Yr.call(e) === "[object Array]")),
				(Ue = function (e, t) {
...
`))
					...
					jsx_readString(y) {
						...
						for (;;) {
							this.pos >= this.input.length &&
								this.raise(this.start, "Unterminated string constant");
							const P = this.input.charCodeAt(this.pos);
							if (P === y) break;
							P === 38
					...
					jsx_parseOpeningElementAt(y, v) {
						...
						B.attributes = [];
						const P = this.jsx_parseElementName();
						for (
							P && (B.name = P);
							...
							(t =
								...
								function (p) {
									for (var m, g = 1, F = arguments.length; g < F; g++) {
										m = arguments[g];
										for (var A in m) Object.hasOwn(m, A) && (p[A] = m[A]);
									}
									return p;
								}),
	...
	return cn(e) === !1
		...
		: ((t = e.constructor),
			t === void 0
				? !0
				: ((r = t.prototype),
					!(cn(r) === !1 || Object.hasOwn(r, "isPrototypeOf") === !1)));
}
var Ns = nt(ns()),
	Be = nt(ss()),
	Pe = (e, t) => (e === 0 ? "" : new Array(e * t).fill(" ").join(""));
function gt(e) {
...
var iu = (e, t, r, n, s) => {
		...
		return e.type === "string"
			? t
					.split(`
`)
					.map((u, h) => (h === 0 ? u : "".concat(Pe(n, o)).concat(u)))
					.join(`
`)
			: t;
	},
	...
	$n = (e, t, r, n, s) => (s ? Pe(r, n).length + t.length > s : e.length > 1),
	au = (e, t, r, n, s, o, u) => ($n(e, t, s, o, u) || r) && !n,
	Jn = (e, t, r, n) => {
		var s = e.type,
			o = e.displayName,
			u = o === void 0 ? "" : o,
...
`)
	...
	ti = (e, t) => {
		...
		_i(() => {
			if (!n) {
				const { id: A, unmappedArgs: C } = t;
				r.emit(Ci, { id: A, source: s, args: C });
			}
		});
		const o = e();
		if (n) return o;
		const u = { ...Ku, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
			h =
				(F =
