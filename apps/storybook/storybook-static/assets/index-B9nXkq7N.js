import { g as _, r as o } from "./index-BGsE_GxY.js";
var s = { exports: {} },
	i = {}; /**
 * @license React
...
i.preconnect = (e, r) => {
	typeof e == "string" &&
		(r
			? ((r = r.crossOrigin),
				(r =
					typeof r == "string" ? (r === "use-credentials" ? r : "") : void 0))
			: (r = null),
		n.d.C(e, r));
};
i.prefetchDNS = (e) => {
...
i.preinit = (e, r) => {
	if (typeof e == "string" && r && typeof r.as == "string") {
		var t = r.as,
			c = g(t, r.crossOrigin),
			u = typeof r.integrity == "string" ? r.integrity : void 0,
			y = typeof r.fetchPriority == "string" ? r.fetchPriority : void 0;
		t === "style"
			? n.d.S(e, typeof r.precedence == "string" ? r.precedence : void 0, {
					crossOrigin: c,
					integrity: u,
					fetchPriority: y,
				})
...
i.requestFormReset = (e) => {
	n.d.r(e);
};
i.unstable_batchedUpdates = (e, r) => e(r);
i.useFormState = (e, r, t) => f.H.useFormState(e, r, t);
i.useFormStatus = () => f.H.useHostTransitionStatus();
i.version = "19.2.6";
function l() {
	if (
		!(
