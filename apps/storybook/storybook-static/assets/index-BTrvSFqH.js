import { c as kn } from "./index-BGsE_GxY.js";
var Je = { exports: {} };
((n, a) => {
	((o, i) => {
		i(a);
		...
		switch ((typeof o < "u" && (u.raw = o), a)) {
			...
			default: {
				if ((a == null ? void 0 : a.indexOf("|")) > 0)
					try {
						const v = a.split("|").map((N) => JSON.parse(N));
...
function G(n, a) {
	...
	if (a != null && a.includesJsDoc) {
		const { description: i, extractedTags: p } = a;
